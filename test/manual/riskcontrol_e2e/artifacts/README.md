...
- `05-logs-100-percent-sampling.png`: Logs tab filtered to `metadata-session:sampling-array`, showing two fresh allow audits for the same session.
...
- `real/08-real-logs-100-percent-sampling.png`: Logs tab showing two live fresh audits for `metadata-session:real-sampling`.
